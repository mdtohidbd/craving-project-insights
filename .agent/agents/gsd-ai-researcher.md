...
<required_reading>
Read `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
