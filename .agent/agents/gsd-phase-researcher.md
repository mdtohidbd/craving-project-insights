...
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/thinking-models-research.md
...
```bash
node "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
