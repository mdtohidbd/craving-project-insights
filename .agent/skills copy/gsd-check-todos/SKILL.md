...
<execution_context>
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/check-todos.md`.
