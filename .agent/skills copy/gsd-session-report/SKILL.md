...
<execution_context>
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/session-report.md end-to-end.
</process>
