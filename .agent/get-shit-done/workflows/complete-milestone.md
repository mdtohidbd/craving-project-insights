...
```bash
node "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/retrospective.md`.
