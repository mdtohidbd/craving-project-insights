...
```
Task(
  prompt="Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/VALIDATION.md`
