...
- **Global scope**: `E:/Skybridge Digital/craving-project-insights/.windsurf/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Skybridge Digital/craving-project-insights/.windsurf/notes/`)
...
2. Glob `E:/Skybridge Digital/craving-project-insights/.windsurf/notes/*.md` (if directory exists) — global notes
...
Global (E:/Skybridge Digital/craving-project-insights/.windsurf/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Skybridge Digital/craving-project-insights/.windsurf/notes/` — works in any directory
