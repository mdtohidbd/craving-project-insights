...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-ui-checker.md for instructions.
