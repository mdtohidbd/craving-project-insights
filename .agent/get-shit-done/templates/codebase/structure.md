...
- Usage: Reference from command with `@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/Skybridge Digital/craving-project-insights/.windsurf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Skybridge Digital/craving-project-insights/.windsurf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
