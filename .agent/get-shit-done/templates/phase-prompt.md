...
<!-- For checkpoint task examples and patterns, see @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/checkpoints.md -->
...
See `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
