    ...
    return (
        <AdminLayout title="Menu Management">
            <div className="flex flex-col lg:flex-row gap-6 h-full items-start">
                {/* Categories Sidebar */}
                <div className="w-full lg:w-80 bg-white border border-neutral-200 rounded-[12px] p-6 shadow-sm">
                    ...
                    <div className="space-y-3">
                        <div
                            ...
                            className={`w-full text-left px-4 py-3 rounded-[8px] transition-colors flex items-center justify-between cursor-pointer ${
                        ...
                        {categories.filter(c => c.name !== "All").sort((a, b) => a.order - b.order).map((category) => {
                            return (
                                <div key={category.name} 
                                    className={`w-full px-4 py-3 rounded-[8px] transition-colors flex items-center justify-between cursor-pointer ${
                                    ...
                                    <tr key={item._id} className="border-b border-neutral-100 hover:bg-neutral-50/50 transition-colors">
                                        ...
                                        <td className="px-2 py-4 text-right">
                                            <div className="flex items-center justify-end gap-3">
                                                <button onClick={() => handleOpenModal(item)} className="p-1.5 text-blue-600 hover:bg-blue-50 transition-colors rounded-[4px]">
                                                    <Edit className="w-4 h-4" />
                                                </button>
                                                <button onClick={() => handleDelete(item._id)} className="p-1.5 text-rose-500 hover:bg-rose-50 transition-colors rounded-[4px]">
