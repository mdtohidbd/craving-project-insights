...
Key references:
- @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/ui-brand.md (display patterns)
- @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md" "E:/Skybridge Digital/craving-project-insights/.windsurf/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/user-profiling.md`
...
Reference: @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .windsurf/rules" -- "Add profile to E:/Skybridge Digital/craving-project-insights/.windsurf/.windsurf/rules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/Skybridge Digital/craving-project-insights/.windsurf/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to E:/Skybridge Digital/craving-project-insights/.windsurf/.windsurf/rules"
...
```bash
BACKUP_PATH="E:/Skybridge Digital/craving-project-insights/.windsurf/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Skybridge Digital/craving-project-insights/.windsurf/commands/gsd/dev-preferences.md
  ✓ .windsurf/rules section       .windsurf/rules
  ✓ Global .windsurf/rules        E:/Skybridge Digital/craving-project-insights/.windsurf/.windsurf/rules
```
