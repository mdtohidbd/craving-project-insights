...
```bash
INIT=$(node "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/spec.md.
