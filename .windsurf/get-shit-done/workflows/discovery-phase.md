...
See E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/discovery.md
...
Use E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/discovery.md.
