...
<template>
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/UAT.md
</template>
...
Read and follow `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/transition.md`.
...
```bash
node "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/diagnose-issues.md
