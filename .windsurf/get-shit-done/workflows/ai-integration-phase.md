...
<required_reading>
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/ai-frameworks.md
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-eval-planner.md for instructions.
