...
<required_reading>
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/domain-probes.md
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/gate-prompts.md
@E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @E:/Skybridge Digital/craving-project-insights/.windsurf/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/workflows/discuss-phase-power.md
