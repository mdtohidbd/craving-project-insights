...
Reference full template: `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Skybridge Digital/craving-project-insights/.windsurf/get-shit-done/templates/state.md`.
